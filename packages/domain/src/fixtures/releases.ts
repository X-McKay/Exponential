...
export const RELEASES: Record<string, Release[]> = {
  onboarding: [
    { id: "R1", name: "Mapping GA", month: 7, milestoneIds: ["MS-15", "MS-12"],
      criteria: [
    ...
    { id: "R2", name: "Ingestion GA", month: 10, milestoneIds: ["MS-13"],
      criteria: [
    ...
    { id: "R3", name: "Full auto-reconciliation", month: 12, milestoneIds: ["MS-14"],
      criteria: [
  ...
  ima: [
    { id: "R1", name: "Shadow mode", month: 9, milestoneIds: ["MS-21"],
      criteria: [
    ...
    { id: "R2", name: "Assisted review pilot", month: 11, milestoneIds: ["MS-22"],
      criteria: [
    ...
    { id: "R3", name: "Gated activation", month: 13, milestoneIds: ["MS-23"],
      criteria: [
  ...
  sector: [
    { id: "R1", name: "Analyst pilot", month: 10, milestoneIds: ["MS-31"],
      criteria: [
    ...
    { id: "R2", name: "Research desk rollout", month: 13, milestoneIds: ["MS-32"],
      criteria: [
