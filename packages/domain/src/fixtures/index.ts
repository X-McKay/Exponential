...
export const seedState = (): AppState =>
  structuredClone({ asOf: SEED_ASOF, syncSource: "sample", workspace: WORKSPACE, projects: PROJECTS, releases: RELEASES, dev: DEV(SEED_ASOF), agents: AGENTS, runs: RUNS(SEED_ASOF), llm: null, proposals: [], scores: [], rules: RULES(SEED_ASOF), promptVersions: [], brief: null, projectBriefs: {}, budgets: [], events: seedEvents(SEED_ASOF), calendar: CALENDAR(SEED_ASOF) });
