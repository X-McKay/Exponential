...
describe("rankBlocks / composeGlance", () => {
  ...
  test("empty state still composes without throwing", () => {
    const empty: AppState = { asOf: "2026-09-10T09:00:00.000Z", syncSource: null, workspace: { user: { name: "You", ini: "ME" } }, projects: [], releases: {}, dev: {}, agents: [], runs: [], llm: null, proposals: [], events: [], calendar: [] };
