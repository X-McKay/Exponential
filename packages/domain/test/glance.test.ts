...
describe("rankBlocks / composeGlance", () => {
  ...
  test("empty state still composes without throwing", () => {
    const empty: AppState = { asOf: "2026-09-10T09:00:00.000Z", syncSource: null, workspace: { user: { name: "You", ini: "ME" }, lastGlanceAt: null }, projects: [], releases: {}, dev: {}, agents: [], runs: [], llm: null, proposals: [], scores: [], rules: [], promptVersions: [], brief: null, events: [], calendar: [] };
